...
class EmojiTableViewController: UITableViewController {
    ...
    var objects = [
        Emoji(emoji: "🥰", name: "Lova", description: "Let's love each other", isFavourite: false),
    ...
    override func tableView(_ tableView: UITableView, leadingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        ...
        let favourite = favoruriteAction(at: indexPath)
    ...
    func favoruriteAction(at indexPath: IndexPath) -> UIContextualAction {
